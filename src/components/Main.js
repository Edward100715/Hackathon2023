    ...
    return (
        <section class="main" id="main">
            <div class="container">
                ...
                <p className="main-firts-text">¡No te pierdas la oportunidad de ser parte de esta emocionante jornada de creación y colaboración! Te esperamos en el Hackathon 2023 de Taxis Libres, donde juntos daremos forma al futuro de la movilidad en taxi.</p>
                <p className="main-second-text">Fecha: 15 al 17 de julio de 2023</p>
                <p className="main-second-text">Lugar: Centro de Convenciones de la Ciudad</p>
            </div>
        </section>
    )
}
